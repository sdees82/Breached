    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            if (!((0, _isValidCollectionPathImplementation.isValidCollectionPathImplementation)(absolutePath) === false)) {
              _context.next = 3;
              break;
            }

            (0, _watchCollectionBuilder.watchCollectionBuilder)(absolutePath, "", [], actions, function () {
              return createPagesFromCollectionBuilder(filePath, absolutePath, actions, graphql);
            });
            return _context.abrupt("return");

          case 3:
            // 1. Query for the data for the collection to generate pages
            queryString = (0, _collectionExtractQueryString.collectionExtractQueryString)(absolutePath); // 1.a  If the query string is not findable, we can't move on. So we stop and watch
          ...
          case 9:
            ...
            _reporter.default.error(("Tried to create pages from the collection builder.\nUnfortunately, the query came back empty. There may be an error in your query.\n\nfile: " + absolutePath + "\n\n" + errors.map(function (error) {
              return error.message;
            }).join("\n")).trim());

            (0, _watchCollectionBuilder.watchCollectionBuilder)(absolutePath, queryString, [], actions, function () {
              return createPagesFromCollectionBuilder(filePath, absolutePath, actions, graphql);
            });
            return _context.abrupt("return");
          ...
          case 16:
            ...
            if (nodes) {
              _reporter.default.info("   Creating " + nodes.length + " page" + (nodes.length > 1 ? "s" : "") + " from " + filePath);
            ...
            paths = nodes.map(function (node) {
              ...
              var path = (0, _gatsbyPageUtils.createPath)((0, _derivePath.derivePath)(filePath, node)); // Params is supplied to the FE component on props.params
            ...
            (0, _watchCollectionBuilder.watchCollectionBuilder)(absolutePath, queryString, paths, actions, function () {
              return createPagesFromCollectionBuilder(filePath, absolutePath, actions, graphql);
            });
