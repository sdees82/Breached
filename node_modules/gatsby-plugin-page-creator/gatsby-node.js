        ...
        switch (_context.prev = _context.next) {
          ...
          case 11:
            ...
            files.forEach(function (file) {
              (0, _createPageWrapper.createPage)(file, pagesDirectory, actions, ignore, graphql);
            });
            (0, _gatsbyPageUtils.watchDirectory)(pagesPath, pagesGlob, function (addedPath) {
              if (!_lodash.default.includes(files, addedPath)) {
                (0, _createPageWrapper.createPage)(addedPath, pagesDirectory, actions, ignore, graphql);
